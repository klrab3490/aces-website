    ...
    <div className="p-5">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {project.map((item) => (
          <div
            key={item.id}
            className="projectcard p-4 bg-gray-300 shadow-md rounded flex flex-col justify-between"
          >
            <div>
              <Image
                src={item.pimg}
            ...
            <h1 className=" text-xl font-satoshi font-semibold flex-center">
              {item.pname}
            </h1>
            ...
            <div className="flex-center">
              <Link
                href={item.git_link}
                className="px-4 py-2 mt-4 mr-2 text-white border-black bg-black rounded hover:bg-gray-200"
              >
                Github
              </Link>
              {item.web_link ? (
