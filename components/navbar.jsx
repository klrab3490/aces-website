...
const Navbar = ({ toggleDarkMode, darkMode }) => {
  ...
  return (
    <nav
      className={`flex-between items-center justify-center w-full mb-3 px-4 py-2 ${
    ...
    >
      ...
      <div className="justify-left">
        <ul className="hidden sm:flex gap-4">
          ...
          <li className="logo_text hover:text-gray-600">
            {" "}
            <Link href={"/studymaterial"}> Study Materials </Link>{" "}
          </li>
          <li className="logo_text hover:text-gray-600">
      ...
      <div className="flex flex-center sm:hidden">
        ...
        <div
          onClick={handleNav}
          className="px-4 z-10 block  hover:text-gray-600"
        >
